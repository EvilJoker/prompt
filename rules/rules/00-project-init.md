...
- **执行模式**: 3阶段交互式：用户信息收集 → 架构文档生成 → 目录结构创建 → 快速开始指南生成
...
**⏸️ 等待用户确认**: 目录结构创建完成，请回复 `yes` 继续快速开始指南生成
...
**📤 生成文件**: `docs/development/快速开始指南.md`
